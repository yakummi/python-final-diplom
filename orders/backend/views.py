...
from backend.models import Shop, Category, Product, ProductInfo, Parameter, ProductParameter, Order, OrderItem, Contact, ConfirmEmailToken
...
class RegisterAccount(APIView):
    def post(self, request, *args, **kwargs):
        ...
        return JsonResponse({
            'Status': False,
            'Errors': 'Not all of the necessary arguments are stated'
        })
...
# Подтверждение для входа в аккаунт
    ...
    def post(self, request, *args, **kwargs):
        if {'email', 'token'}.issubset(request.data):
            ...
            if token:
                ...
                return JsonResponse({
                    'Status': False,
                    'Errors': 'Incorrect token or email address'
                })
        return JsonResponse({
            'Status': False,
            'Errors': 'Not all of the necessary arguments are stated'
...
class BasketView(APIView):
    ...
    def post(self, request, *args, **kwargs):
        ...
        if items_sting:
            try:
                ...
                return JsonResponse({
                    'Status': True,
                    'Created objects': objects_created
                })
        return JsonResponse({
            'Status': False,
            'Errors': 'Not all of the necessary arguments are stated'
    ...
    def put(self, request, *args, **kwargs):
        ...
        if items_sting:
            ...
            return JsonResponse({'Status': False, 'Errors': 'Not all of the necessary arguments are stated'})
        ...
        if {'id', 'contact'}.issubset(request.data):
            if request.data['id'].isdigit():
                try:
                    ...
                    print(error)
                    return JsonResponse({'Status': False, 'Errors': 'Incorrectly stated arguments'})
                else:
                    if is_updated:
